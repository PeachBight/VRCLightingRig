Shader "MetacosmStudios/CameraShy/Trans_Tex_1_2_0"
{
    //version 1.2.0
    Properties{
      _MainTex("Texture", 2D) = "white" {}
      _AlphaMul("Alpha Multiply",Float) = 1.0
      _AlphaAdd("Alpha Add",Float) = 0.0
      ...
      [MaterialToggle] _ShowInMirror("Show In Mirror", Float) = 0
        ...
        SubShader{
            ...
            void surf(Input IN, inout SurfaceOutput o) {
                ...
                fixed4 col = tex2D(_MainTex, IN.uv_MainTex) * _ColorTint;
                o.Albedo = col.rgb;
                o.Alpha = col.a * _AlphaMul + _AlphaAdd;
                o.Emission = tex2D(_EmissionTex, IN.uv_EmissionTex) * col.rgb * pow(2,_Emission) * _EmissionColor.a;
            }
            ENDCG
      }
      Fallback "Diffuse"
