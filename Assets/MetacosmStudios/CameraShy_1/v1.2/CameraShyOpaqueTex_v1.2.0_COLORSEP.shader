Shader "MetacosmStudios/CameraShy/Opaque_Tex_1_2_0_COLORSEP"
{
    //version 1.2.0
    Properties{
      ...
      _EmissionColor_R("Emission Color RED",Float) = 0.1
      _EmissionColor_G("Emission Color GREEN",Float) = 0.1
      _EmissionColor_B("Emission Color BLUE",Float) = 0.1
      _EmissionTex("Texture", 2D) = "white" {}
      //_ColorTint("Tint", Color) = (1.0, 1.0, 1.0, 1.0)
      _ColorTint_R("Tint RED", Float) = 1.0
      _ColorTint_G("Tint GREEN", Float) = 1.0
      _ColorTint_B("Tint BLUE", Float) = 1.0
      ...
      [MaterialToggle] _ShowInMirror("Show In Mirror", Float) = 0
        ...
        SubShader{
            ...
            float _EmissionColor_R, _EmissionColor_G, _EmissionColor_B;
            //fixed4 _ColorTint;
            float _ColorTint_R, _ColorTint_G, _ColorTint_B;
            bool _ShowInVRCL;
            bool _IsInvisible;
            bool _ShowInMirror;
            ...
            void surf(Input IN, inout SurfaceOutput o) {
                ...
                fixed4 col = tex2D(_MainTex, IN.uv_MainTex) * float4(_ColorTint_R, _ColorTint_G, _ColorTint_B,1.0);
                o.Albedo = col.rgb;
                o.Alpha = col.a;
                o.Emission = tex2D(_EmissionTex, IN.uv_EmissionTex) * float4(_EmissionColor_R, _EmissionColor_G, _EmissionColor_B,1.0) * pow(2, _Emission);
            }
            ENDCG
      }
      Fallback "Diffuse"
